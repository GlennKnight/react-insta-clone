            ...
            <VStack alignItems={'flex-start'} gap={2} mx={'auto'} flex={1}>
                <Flex gap={4} direction={{ base: 'column', sm: 'row' }} justifyContent={{ base: 'center', sm: 'flex-start' }} w={'full'}>
                    ...
                    <Flex gap={4} alignItems={'center'} justifyContent={'center'}>
                        {visitingOwnProfileAndAuth && <Button bg={'white'} color={'black'} _hover={{ bg: 'whiteAlpha.800' }} size={{ base: 'xs', md: 'sm' }}>Edit Profile</Button>}
                        {visitingAnotherProfileAndAuth && <Button bg={'blue.500'} color={'white'} _hover={{ bg: 'blue.600' }} size={{ base: 'xs', md: 'sm' }}>Follow</Button>}
